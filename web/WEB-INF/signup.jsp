<%--
  ...
  ~ Applied Sciences (H�gskulen p� Vestlandet, HVL) in Bergen, Norway.
  ~
  --%>
            ...
            <div class="card blue-grey darken-1 s12">
                <div class="card-content white-text">
                    ...
                    <select name="countryCode" id="countryCode">
                        <option data-countryCode="NO" value="47" Selected> Norway (+47)</option>
                ...
                <div class="card-action">
                    <button class="waves-effect waves-light btn" id="Login" type="submit">Register</button>
                    <button class="waves-effect waves-light btn" type="button"
                            onclick="window.location.href = 'login';">To Login
                    </button>
                </div>
            </div>
